...
mutare_fisiere_local(){
    ...
    cautare_fisiere . | xargs -I {} mv {} "$destinatie" && echo "Fișierele au fost mutate în $destinatie." || echo "Eroare la mutarea fișierelor."
}
...
mutare_fisiere_git(){
    ...
    git add -A && echo "Toate modificările au fost adăugate în staging area." || echo "Eroare la adăugarea modificărilor în staging area."
